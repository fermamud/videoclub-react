        ...
        <main>
            ...
            <div className="notes">
                ...
                <div className="etoiles">
                    <button onClick={() => soumettreNote(1)}>
                    <svg width="177" height="169" viewBox="0 0 177 169" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick1}>
                    <path d="M88.5 0L108.369 58.3881H172.669L120.65 94.4739L140.519 152.862L88.5 116.776L36.481 152.862L56.3505 94.4739L4.3315 58.3881H68.6305L88.5 0Z" fill="#DDB03B" fill-opacity="1"/>
                    ...
                    <button onClick={() => soumettreNote(2)}>
                    <svg width="177" height="169" viewBox="0 0 177 169" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick2}>
                    <path d="M88.5 0L108.369 58.3881H172.669L120.65 94.4739L140.519 152.862L88.5 116.776L36.481 152.862L56.3505 94.4739L4.3315 58.3881H68.6305L88.5 0Z" fill="#DDB03B" fill-opacity="1"/>
                    ...
                    <button onClick={() => soumettreNote(3)}>
                    <svg width="177" height="169" viewBox="0 0 177 169" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick3}>
                    <path d="M88.5 0L108.369 58.3881H172.669L120.65 94.4739L140.519 152.862L88.5 116.776L36.481 152.862L56.3505 94.4739L4.3315 58.3881H68.6305L88.5 0Z" fill="#DDB03B" fill-opacity="1"/>
                    ...
                    <button onClick={() => soumettreNote(4)}>
                    <svg width="177" height="169" viewBox="0 0 177 169" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick4}>
                    <path d="M88.5 0L108.369 58.3881H172.669L120.65 94.4739L140.519 152.862L88.5 116.776L36.481 152.862L56.3505 94.4739L4.3315 58.3881H68.6305L88.5 0Z" fill="#DDB03B" fill-opacity="1"/>
                    ...
                    <button onClick={() => soumettreNote(5)}>
                    <svg width="177" height="169" viewBox="0 0 177 169" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleClick5}>
                    <path d="M88.5 0L108.369 58.3881H172.669L120.65 94.4739L140.519 152.862L88.5 116.776L36.481 152.862L56.3505 94.4739L4.3315 58.3881H68.6305L88.5 0Z" fill="#DDB03B" fill-opacity="1"/>
